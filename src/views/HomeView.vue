<template>
  ...
  <div class="section s_career">
      ...
      <ul>
        ...
        <li class="spreadsection" :class="{ active: isOpen(1) }" @mouseenter="onHover(1)" @mouseleave="onLeave">
          <div class="c_front">
        ...
        <li class="spreadsection" :class="{ active: isOpen(2) }" @mouseenter="onHover(1)" @mouseleave="onLeave">
          <div class="c_front" v-if="isOpen(2)">
        ...
        <li class="spreadsection" :class="{ active: isOpen(3) }" @mouseenter="onHover(1)" @mouseleave="onLeave">
          <div class="c_front">
        ...
        <li class="spreadsection" :class="{ active: isOpen(4) }" @mouseenter="onHover(1)" @mouseleave="onLeave">
          <div class="c_front">
  ...
  <div class="s_subscribe">
      ...
      <form>
        ...
        <button type="submit"><img src="../assets/submit_arrow.svg" alt="검색"/></button>
      </form>
  </div>
...
.s_career{
  ...
  ul{
    ...
    /* li가 hover 되었을 때 */
      &:nth-child(3):hover,&:nth-child(4):hover,&:nth-child(5):hover,&.active{
        flex-grow: 6;
        height: 100%;
        color: white;
        .c_front{
